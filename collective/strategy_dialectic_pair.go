...
func (*DialecticPair) Select(_ context.Context, agents []jericho.Actor) []jericho.Actor {
...
func (dp *DialecticPair) Execute(ctx context.Context, prompt string, agents []jericho.Actor) (string, error) {
...
func (dp *DialecticPair) Orchestrate(ctx context.Context, prompt string, agents []jericho.Actor) (string, error) {
